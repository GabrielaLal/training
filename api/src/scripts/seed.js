  ...
  try {
    ...
    const venues = await VenueObject.create([
      ...
      },
      {
        ...
        country: "France",
        capacity: 100,
        amenities: ["WiFi", "Bar", "Networking Space"],
        owner_id: users[0]._id.toString(),
      },
      {
        ...
        country: "France",
        capacity: 200,
        amenities: ["WiFi", "Projector", "Sound System", "Seating"],
        owner_id: users[2]._id.toString(),
      },
      {
    ...
    const events = await EventObject.create([
      {
        ...
        venue_id: venues[0]._id.toString(),
        venue_name: venues[0].name,
        venue_address: venues[0].address,
        venue_city: venues[0].city,
        venue_country: venues[0].country,
        capacity: 500,
        available_spots: 500,
        price: 0,
        currency: "EUR",
        status: "published",
        category: "conference",
        organizer_id: users[0]._id.toString(),
      ...
      },
      {
        ...
        venue_id: venues[1]._id.toString(),
        venue_name: venues[1].name,
        venue_address: venues[1].address,
        venue_city: venues[1].city,
        venue_country: venues[1].country,
        capacity: 30,
        available_spots: 30,
        price: 49.99,
        currency: "EUR",
        status: "published",
        category: "workshop",
        organizer_id: users[1]._id.toString(),
      ...
      },
      {
        ...
        venue_id: venues[2]._id.toString(),
        venue_name: venues[2].name,
        venue_address: venues[2].address,
        venue_city: venues[2].city,
        venue_country: venues[2].country,
        capacity: 100,
        available_spots: 100,
        price: 0,
        currency: "EUR",
      ...
      },
      {
        ...
        venue_id: venues[3]._id.toString(),
        venue_name: venues[3].name,
        venue_address: venues[3].address,
        venue_city: venues[3].city,
        venue_country: venues[3].country,
        capacity: 200,
        available_spots: 200,
        price: 29.99,
        currency: "EUR",
        status: "published",
        category: "seminar",
        organizer_id: users[2]._id.toString(),
      ...
      },
      {
        ...
        venue_id: venues[4]._id.toString(),
        venue_name: venues[4].name,
        venue_address: venues[4].address,
        venue_city: venues[4].city,
        venue_country: venues[4].country,
        capacity: 50,
        available_spots: 50,
        price: 0,
        currency: "EUR",
